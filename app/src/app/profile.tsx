...
import { ProfileAchievements, ProfileBACCard, ProfileHeader, ProfileStats } from '@/components/profile';
...
export default function ProfileScreen() {
    ...
    const { beers, roundBeers, achievements, refreshing, refresh } = useProfileData(currentUser, activeEvent);
