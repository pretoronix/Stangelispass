    ...
    jest.doMock('react-native', () => {
        ...
        return {
            Pressable: ({ onPress, children, disabled, ...rest }: any) => (
                React.createElement('pressable', { ...rest, onPress: disabled ? undefined : onPress }, children)
            ),
...
describe('Button', () => {
    ...
    test('calls onPress when pressed', () => {
        ...
        const { getByTestId } = render(<Button title="Test" onPress={onPress} testID="btn" />);
    ...
    test('does not trigger haptics on android', () => {
        ...
        const { getByTestId } = render(<Button title="Test" onPress={() => {}} testID="btn" />);
        fireEvent.press(getByTestId('btn'));
