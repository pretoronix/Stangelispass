import { PASS_TYPES, PASS_TYPE_DURATIONS_DAYS, PASS_TYPE_LABELS, PASS_TYPE_PRICES_CHF } from '@/utils/settings/settingsConstants';

describe('pass type constants', () => {
    test('exposes the expected pass types', () => {
        expect(PASS_TYPES).toEqual(['day', 'week', 'year']);
    });
