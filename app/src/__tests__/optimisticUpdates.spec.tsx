...
const mockAddBeer = beersService.addBeer as jest.MockedFunction<typeof beersService.addBeer>;
const mockRemoveBeer = beersService.removeBeer as jest.MockedFunction<typeof beersService.removeBeer>;
...
describe('Optimistic Updates', () => {
    ...
    describe('useAddBeer', () => {
        it('should update cache optimistically', async () => {
            ...
            await waitFor(() => {
                const cached = queryClient.getQueryData(QUERY_KEYS.beers(eventId)) as any[];
        ...
        it('should update beer counts optimistically', async () => {
            ...
            await waitFor(() => {
                const counts = queryClient.getQueryData(QUERY_KEYS.beerCounts(eventId)) as any[];
