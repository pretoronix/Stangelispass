...
type EventPasses = ReturnType<typeof useEventPasses>;
    ...
    >
      ...
      <View style={styles.section}>
        <PremiumTierCard
          ...
          onBuyLifetime={eventPasses.handlePurchaseLifetime}
        />
      </View>
      ...
      <View style={styles.section}>
        ...
        <PromoCodeSection
          isAdmin={isAdmin}
          currentUser={currentUser}
          codes={eventPasses.promoCodes}
          loading={eventPasses.loadingCodes}
          generating={eventPasses.generating}
          redeeming={eventPasses.redeeming}
          redeemCode={eventPasses.redeemCode}
          setRedeemCode={eventPasses.setRedeemCode}
          onGenerateCode={eventPasses.handleGeneratePromoCode}
          onRedeemCode={eventPasses.handleRedeemPromoCode}
          onRefresh={eventPasses.refreshPromoCodes}
        />
      </View>
        ...
        <View style={styles.section}>
          ...
          <NotificationsSection
            ...
            onToggleAdminBroadcasts={
              notificationPreferences.toggleAdminBroadcasts
            }
