...
export const getPermissionsForRole = (
  ...
  return {
    ...rolePermissions,
    canManageEvent:
      rolePermissions.canManageEvent ||
      PERMISSIONS_BY_ROLE.admin.canManageEvent,
    canManageMembers:
      rolePermissions.canManageMembers ||
      PERMISSIONS_BY_ROLE.admin.canManageMembers,
    canManageLogs:
      rolePermissions.canManageLogs || PERMISSIONS_BY_ROLE.admin.canManageLogs,
    canIssueStamps:
      rolePermissions.canIssueStamps ||
      PERMISSIONS_BY_ROLE.admin.canIssueStamps,
    canCloseEvent:
      rolePermissions.canCloseEvent || PERMISSIONS_BY_ROLE.admin.canCloseEvent,
    canInvite: rolePermissions.canInvite || PERMISSIONS_BY_ROLE.admin.canInvite,
    canResetEventData:
      rolePermissions.canResetEventData ||
      PERMISSIONS_BY_ROLE.admin.canResetEventData,
  };
};
