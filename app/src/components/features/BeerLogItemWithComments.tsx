...
export function BeerLogItemWithComments({
  ...
  const canDelete =
    currentUserId && (beer.user_id === currentUserId || currentUserIsAdmin);

  return (
    <View
      style={[styles.container, isOptimistic && styles.containerOptimistic]}
    >
      {/* Beer Log Header */}
        ...
        <View style={styles.headerLeft}>
          ...
          <View style={styles.headerInfo}>
            ...
            <Text style={styles.timestamp}>
              {formatDistanceToNow(new Date(beer.created_at), {
                addSuffix: true,
              })}
            </Text>
          </View>
