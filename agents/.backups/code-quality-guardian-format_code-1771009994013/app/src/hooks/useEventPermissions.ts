...
import { getPermissionsForRole, EventPermissions, EventRole } from '@/services/permissions';
...
export function useHasEventAdminRights(
    ...
    return permissions.canManageEvent || permissions.canManageMembers || permissions.canManageLogs;
}
