...
export const LeaderboardItem = memo(({ item, index, isLeader }: LeaderboardItemProps) => {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                <View style={styles.nameRow}>
                    ...
                    {isLeader && <Ionicons name="trophy" size={14} color="#FFD700" style={styles.leaderIcon} />}
                </View>
                {item.isAdmin && (
            ...
            <View style={styles.countContainer}>
                ...
                {showPoints && <Text style={styles.subCountText}>{item.count} BEERS</Text>}
            </View>
        </View>
    );
});
