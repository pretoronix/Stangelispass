...
- **Notification prefs**: `app/src/services/types.ts`, `app/src/services/users.ts`
- **Templates**: `app/src/services/notificationTemplates.ts`
- **Service enqueue**: `app/src/services/notifications.ts` (`sendAdminBroadcast`)
- **React Query mutation**: `app/src/hooks/useNotificationsQuery.ts`
- **UI**:
  - `app/src/components/notifications/BroadcastModal.tsx`
  - `app/src/components/notifications/BroadcastMessageInput.tsx`
  - `app/src/components/notifications/BroadcastActions.tsx`
  - `app/src/components/notifications/broadcastModalStyles.ts`
  - Home screen integration in `app/src/app/index.tsx` and `app/src/components/home/HomeHeader.tsx`
- **Settings opt-out**: `app/src/components/settings/NotificationsSection.tsx` + `app/src/hooks/settings/useNotificationPreferences.ts`
- **Notification handling**: `app/src/hooks/useNotificationHandler.ts` (wired in `app/src/app/_layout.tsx`)
- **Tests**:
  - `app/src/components/notifications/__tests__/BroadcastModal.spec.tsx`
  - `app/src/__tests__/notificationProcessor.spec.ts` (admin broadcast flow + prefs)
...
### Phase 1: Schema Updates ✅ (1 hour) — Implemented
...
### Phase 2: Service Layer ✅ (2 hours) — Implemented
...
### Phase 3: React Query Hook ✅ (1 hour) — Implemented
...
### Phase 4: UI Components ✅ (3 hours) — Implemented
...
### Phase 5: Settings Integration ✅ (1 hour) — Implemented
...
### Phase 6: Notification Handlers ✅ (2 hours) — Implemented
...
### Phase 7: Testing & Polish ✅ (2 hours) — Implemented
