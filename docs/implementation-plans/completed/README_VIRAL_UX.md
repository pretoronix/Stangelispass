...
open docs/implementation-plans/completed/VIRAL_UX_QUICKREF.md

# Then review full plan
open docs/implementation-plans/completed/08-viral-ux-features.md

# Check design specs
open docs/implementation-plans/completed/VIRAL_UX_DESIGN_MOCKUPS.md
```
